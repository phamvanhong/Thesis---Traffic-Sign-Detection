...
class AdjustBoundingBoxes:
    def __init__(self,folder_path,  annotation_paths: list, image_width, image_height):
        """
    ...
    def resize_bboxes_adjust(self, lines: list):
        """
        ...
        for annotation_file_path in self.annotation_paths:
            ...
            with open(new_file_path, 'w') as file:
                for annotation in annotations:
                    ...
                    file.write(f"{label} {center_x} {center_y} {box_width} {box_height}\n")
