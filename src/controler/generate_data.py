...
def main():
    train_data_folder = r"data\VN_Traffic_Sign_Robo\train\images"
    ...
    # high_contrast_aug.process_images(high_contrast_aug.change_contrast, 1.0)
    ...
    # brightness_aug.process_images(brightness_aug.modified_color, 1.0)
